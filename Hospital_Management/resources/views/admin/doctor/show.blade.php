        ...
        <div class="card-header py-3">
            <div class="d-flex flex-row">
                ...
                <div class="col-md-2" style="margin-left: 65px;">
                    <a href="{{route('doctorList.index')}}" class="btn btn-info btn-sm pl-10">Back to list</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="d-flex flex-row mb-3">
                    ...
                    <div class="col-4 p-2" style="border-right: 1px dotted black">
                        ...
                        <tr>
                            ...
                            <td>{{ $userInfo->educationQualification->name }}</td>
                        </tr>
                        <br>
                        <tr>
                            <td>Collage Name: </td>
                            <td>{{ $userInfo->CollageName->name }}</td>
                        </tr>
                        <br>
                        <tr>
                            <td>Passing Year: </td>
                            <td>{{ $userInfo->passing_year }}</td>
                        </tr>
                        <br>
                        <tr>
                            <td>Specialist: </td>
                            <td>{{ $userInfo->Specialist->name }}</td>
                        </tr>
                    </div>
