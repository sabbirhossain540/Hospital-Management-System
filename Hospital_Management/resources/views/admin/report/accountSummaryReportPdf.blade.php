...
<h4 class="text-center" style="margin-top: -25px;">Account Summary Report</h4>
...
<table class="table table-sm table-bordered">
    ...
    <tr>
        ...
        <th class="text-center" scope="col">Total Income</th>
    ...
    <tbody>
        <tr>
            ...
            <td class="text-center">{{ $totalExpense}}</td>
            <td class="text-center">{{ $profitCalculation }}</td>
        </tr>
    </tbody>
</table>
