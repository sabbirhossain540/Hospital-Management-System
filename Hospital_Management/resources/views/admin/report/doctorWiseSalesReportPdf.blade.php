...
<head>
    ...
    <title>Doctor Wise Sales Report</title>
</head>
<body>
<table>
    <tr>
...
<h4 class="text-center" style="margin-top: -25px;">Doctor Wise Sales Report</h4>
    ...
    <tbody>
        @foreach($recordList as $key=>$list)
            <tr>
                ...
                <td class="text-center">@if(!empty($list->getServiceName->name)){{ $list->getServiceName->name }}@endif</td>
        ...
        @endforeach
            ...
            <tr style="border-top: 2px solid black !important;">
                ...
                <td class="text-center">{{ floor($totalQuantity) }}</td>
